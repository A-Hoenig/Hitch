...
class Trip(models.Model):
    ...
    depart = models.ForeignKey(Location, on_delete=models.SET_DEFAULT, default="no record", related_name="depart", null=True, blank=True)
    destination = models.ForeignKey(Location, on_delete=models.SET_DEFAULT, default="no record", null=True, blank=True)
